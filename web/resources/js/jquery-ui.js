...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		nextText: "Вперёд", // Display text for next month link
		currentText: "Сегодня", // Display text for current month link
		monthNames: ["Январь","Февраль","Март","Апрель","Май","Июнь",
			"Июль","Август","Сентябрь","Октябрь","Ноябрь","Декабрь"], // Names of months for drop-down and formatting
		monthNamesShort: ["Янв", "Фев", "Мар", "Апр", "Май", "Июн", "Июл", "Авг", "Сен", "Окт", "Ноя", "Дек"], // For formatting
		dayNames: ["Воскресенье", "Понедельник", "Вторник", "Среда", "Четверг", "Пятница", "Субота"], // For formatting
		dayNamesShort: ["Воск", "Пон", "Вт", "Ср", "Четв", "Пят", "Суб"], // For formatting
		dayNamesMin: ["В","П","Вт","С","Ч","П","Сб"], // Column headings for days starting at Sunday
